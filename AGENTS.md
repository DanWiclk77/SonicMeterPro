...
- **Environment Versions:** Always favor **Java 25** for Android/cross-platform tasks and **Node.js 24+** for build scripts and actions to avoid deprecation and compatibility warnings.
