...
- **Environment Versions:** Always favor **Java 26** for Android/cross-platform tasks and the **latest stable version of Node.js** (Node 24+) for build scripts and actions to avoid deprecation warnings.
